...
\begin{abstract}
The aim of this study was to investigate to what degree a machine learning model can capture the team strength depending on composition and help in finding out the result of a cricket match. The target competition was the World Cup 2019.   Basic features comprising of batting and bowling metrics was used along with features capturing the impact and quality of players. Team's batting and bowling strength was also created based on playing squad for a match and venue where the match was played. 
The model was tested with different with training dataset. Result showed how greatly odi crickets have changed with time. 
\end{abstract}

\section{Introduction}

Writing a paper on cricket clairv
